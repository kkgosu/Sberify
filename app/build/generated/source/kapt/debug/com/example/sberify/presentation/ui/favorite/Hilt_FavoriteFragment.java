...
public abstract class Hilt_FavoriteFragment<T extends ViewBinding> extends BaseViewBindingFragment<T> implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((FavoriteFragment_GeneratedInjector) generatedComponent()).injectFavoriteFragment(UnsafeCasts.<FavoriteFragment>unsafeCast(this));
  }
