...
import com.kvlg.shared.di.CoroutineModule_ProvidesIoDispatcherFactory;
...
public final class DaggerSberifyApp_HiltComponents_SingletonC extends SberifyApp_HiltComponents.SingletonC {
  ...
  private final class ActivityRetainedCImpl extends SberifyApp_HiltComponents.ActivityRetainedC {
    ...
    private Provider<CoroutineDispatcher> ioDispatcherCoroutineDispatcherProvider() {
      Object local = providesIoDispatcherProvider;
      if (local == null) {
        local = new SwitchingProvider<>(4);
        providesIoDispatcherProvider = (Provider<CoroutineDispatcher>) local;
      }
    ...
    private final class ActivityCImpl extends SberifyApp_HiltComponents.ActivityC {
      ...
      private LyricsViewModel_AssistedFactory lyricsViewModel_AssistedFactory() {
        return LyricsViewModel_AssistedFactory_Factory.newInstance((Provider) ActivityRetainedCImpl.this.geniusApiImplProvider(), ActivityRetainedCImpl.this.databaseRepositoryProvider(), ActivityRetainedCImpl.this.ioDispatcherCoroutineDispatcherProvider());
      }
      ...
      private SharedViewModel_AssistedFactory sharedViewModel_AssistedFactory() {
        return SharedViewModel_AssistedFactory_Factory.newInstance((Provider) ActivityRetainedCImpl.this.spotifyApiImplProvider(), ActivityRetainedCImpl.this.databaseRepositoryProvider(), ActivityRetainedCImpl.this.ioDispatcherCoroutineDispatcherProvider());
      }
    ...
    private final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 4: // @com.kvlg.shared.di.IoDispatcher kotlinx.coroutines.CoroutineDispatcher 
          return (T) CoroutineModule_ProvidesIoDispatcherFactory.providesIoDispatcher();

          case 5: // com.kvlg.spotify_impl.SpotifyApiImpl 
