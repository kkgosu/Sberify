...
public abstract class Hilt_LyricsFragment<T extends ViewBinding> extends BaseViewBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LyricsFragment_GeneratedInjector) this.generatedComponent()).injectLyricsFragment(UnsafeCasts.<LyricsFragment>unsafeCast(this));
    }
  }
