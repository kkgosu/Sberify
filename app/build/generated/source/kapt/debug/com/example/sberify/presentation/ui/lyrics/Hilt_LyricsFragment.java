...
public abstract class Hilt_LyricsFragment<T extends ViewBinding> extends BaseViewBindingFragment<T> implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((LyricsFragment_GeneratedInjector) generatedComponent()).injectLyricsFragment(UnsafeCasts.<LyricsFragment>unsafeCast(this));
  }
