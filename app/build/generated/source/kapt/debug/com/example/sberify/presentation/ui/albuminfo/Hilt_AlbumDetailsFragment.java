...
public abstract class Hilt_AlbumDetailsFragment<T extends ViewBinding> extends BaseViewBindingFragment<T> implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((AlbumDetailsFragment_GeneratedInjector) generatedComponent()).injectAlbumDetailsFragment(UnsafeCasts.<AlbumDetailsFragment>unsafeCast(this));
  }
