...
public abstract class Hilt_AlbumDetailsFragment<T extends ViewBinding> extends BaseViewBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlbumDetailsFragment_GeneratedInjector) this.generatedComponent()).injectAlbumDetailsFragment(UnsafeCasts.<AlbumDetailsFragment>unsafeCast(this));
    }
  }
