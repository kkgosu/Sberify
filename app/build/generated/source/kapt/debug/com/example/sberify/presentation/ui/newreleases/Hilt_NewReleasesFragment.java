...
public abstract class Hilt_NewReleasesFragment<T extends ViewBinding> extends BaseViewBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewReleasesFragment_GeneratedInjector) this.generatedComponent()).injectNewReleasesFragment(UnsafeCasts.<NewReleasesFragment>unsafeCast(this));
    }
  }
