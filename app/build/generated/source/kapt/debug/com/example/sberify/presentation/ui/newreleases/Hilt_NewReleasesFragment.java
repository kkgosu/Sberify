...
public abstract class Hilt_NewReleasesFragment<T extends ViewBinding> extends BaseViewBindingFragment<T> implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((NewReleasesFragment_GeneratedInjector) generatedComponent()).injectNewReleasesFragment(UnsafeCasts.<NewReleasesFragment>unsafeCast(this));
  }
