...
public abstract class Hilt_SearchFragment<T extends ViewBinding> extends BaseViewBindingFragment<T> implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((SearchFragment_GeneratedInjector) generatedComponent()).injectSearchFragment(UnsafeCasts.<SearchFragment>unsafeCast(this));
  }
