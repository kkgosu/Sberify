...
class NewReleasesAdapter(private val interaction: Interaction? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_new_release,
                parent,
                false), interaction)
    }
